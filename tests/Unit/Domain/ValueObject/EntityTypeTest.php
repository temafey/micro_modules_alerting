...
class EntityTypeTest extends UnitTestCase
{
     ...
     * @group unit
     *
     * @covers       \MicroModule\Alerting\Domain\ValueObject\EntityType::fromNative
     *
     * @dataProvider \MicroModule\Alerting\Tests\Unit\DataProvider\Domain\ValueObject\EntityTypeDataProvider::getDataForFromNativeMethod()
     *
     ...
     * @group unit
     *
     * @covers       \MicroModule\Alerting\Domain\ValueObject\EntityType::toNative
     *
     * @dataProvider \MicroModule\Alerting\Tests\Unit\DataProvider\Domain\ValueObject\EntityTypeDataProvider::getDataForToNativeMethod()
     *
     * @param mixed[] $mockArgs
     * @param mixed[] $mockTimes
     */
     ...
     * @group unit
     *
     * @covers       \MicroModule\Alerting\Domain\ValueObject\EntityType::sameValueAs
     *
     * @dataProvider \MicroModule\Alerting\Tests\Unit\DataProvider\Domain\ValueObject\EntityTypeDataProvider::getDataForSameValueAsMethod()
     *
     * @param mixed[] $mockArgs
     * @param mixed[] $mockTimes
     */
     ...
     * @group unit
     *
     * @covers       \MicroModule\Alerting\Domain\ValueObject\EntityType::isEmpty
     *
     * @dataProvider \MicroModule\Alerting\Tests\Unit\DataProvider\Domain\ValueObject\EntityTypeDataProvider::getDataForIsEmptyMethod()
     *
     * @param mixed[] $mockArgs
     * @param mixed[] $mockTimes
     */
     ...
     * @group unit
     *
     * @covers       \MicroModule\Alerting\Domain\ValueObject\EntityType::__toString
     *
     * @dataProvider \MicroModule\Alerting\Tests\Unit\DataProvider\Domain\ValueObject\EntityTypeDataProvider::getDataFor__toStringMethod()
     *
     * @param mixed[] $mockArgs
     * @param mixed[] $mockTimes
     */
