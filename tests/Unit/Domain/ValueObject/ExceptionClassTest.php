...
class ExceptionClassTest extends UnitTestCase
{
     ...
     * @group unit
     *
     * @covers       \MicroModule\Alerting\Domain\ValueObject\ExceptionClass::fromNative
     *
     * @dataProvider \MicroModule\Alerting\Tests\Unit\DataProvider\Domain\ValueObject\ExceptionClassDataProvider::getDataForFromNativeMethod()
     *
    ...
    public function fromNativeShouldReturnStringLiteralTest(array $mockArgs, array $mockTimes): void
    {
        ...
        $test = ExceptionClass::fromNative();
     ...
     * @group unit
     *
     * @covers       \MicroModule\Alerting\Domain\ValueObject\ExceptionClass::toNative
     *
     * @dataProvider \MicroModule\Alerting\Tests\Unit\DataProvider\Domain\ValueObject\ExceptionClassDataProvider::getDataForToNativeMethod()
     *
     * @param mixed[] $mockArgs
     * @param mixed[] $mockTimes
     */
     ...
     * @group unit
     *
     * @covers       \MicroModule\Alerting\Domain\ValueObject\ExceptionClass::sameValueAs
     *
     * @dataProvider \MicroModule\Alerting\Tests\Unit\DataProvider\Domain\ValueObject\ExceptionClassDataProvider::getDataForSameValueAsMethod()
     *
     * @param mixed[] $mockArgs
     * @param mixed[] $mockTimes
     */
     ...
     * @group unit
     *
     * @covers       \MicroModule\Alerting\Domain\ValueObject\ExceptionClass::isEmpty
     *
     * @dataProvider \MicroModule\Alerting\Tests\Unit\DataProvider\Domain\ValueObject\ExceptionClassDataProvider::getDataForIsEmptyMethod()
     *
     * @param mixed[] $mockArgs
     * @param mixed[] $mockTimes
     */
     ...
     * @group unit
     *
     * @covers       \MicroModule\Alerting\Domain\ValueObject\ExceptionClass::__toString
     *
     * @dataProvider \MicroModule\Alerting\Tests\Unit\DataProvider\Domain\ValueObject\ExceptionClassDataProvider::getDataFor__toStringMethod()
     *
     * @param mixed[] $mockArgs
     * @param mixed[] $mockTimes
     */
