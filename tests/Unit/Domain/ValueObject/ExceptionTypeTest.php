...
class ExceptionTypeTest extends UnitTestCase
{
     ...
     * @group unit
     *
     * @covers       \MicroModule\Alerting\Domain\ValueObject\ExceptionType::fromNative
     *
     * @dataProvider \MicroModule\Alerting\Tests\Unit\DataProvider\Domain\ValueObject\ExceptionTypeDataProvider::getDataForFromNativeMethod()
     *
     ...
     * @group unit
     *
     * @covers       \MicroModule\Alerting\Domain\ValueObject\ExceptionType::toNative
     *
     * @dataProvider \MicroModule\Alerting\Tests\Unit\DataProvider\Domain\ValueObject\ExceptionTypeDataProvider::getDataForToNativeMethod()
     *
     * @param mixed[] $mockArgs
     * @param mixed[] $mockTimes
     */
     ...
     * @group unit
     *
     * @covers       \MicroModule\Alerting\Domain\ValueObject\ExceptionType::sameValueAs
     *
     * @dataProvider \MicroModule\Alerting\Tests\Unit\DataProvider\Domain\ValueObject\ExceptionTypeDataProvider::getDataForSameValueAsMethod()
     *
     * @param mixed[] $mockArgs
     * @param mixed[] $mockTimes
     */
     ...
     * @group unit
     *
     * @covers       \MicroModule\Alerting\Domain\ValueObject\ExceptionType::isEmpty
     *
     * @dataProvider \MicroModule\Alerting\Tests\Unit\DataProvider\Domain\ValueObject\ExceptionTypeDataProvider::getDataForIsEmptyMethod()
     *
     * @param mixed[] $mockArgs
     * @param mixed[] $mockTimes
     */
     ...
     * @group unit
     *
     * @covers       \MicroModule\Alerting\Domain\ValueObject\ExceptionType::__toString
     *
     * @dataProvider \MicroModule\Alerting\Tests\Unit\DataProvider\Domain\ValueObject\ExceptionTypeDataProvider::getDataFor__toStringMethod()
     *
     * @param mixed[] $mockArgs
     * @param mixed[] $mockTimes
     */
